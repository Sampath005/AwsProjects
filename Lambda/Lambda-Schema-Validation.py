# Feel free to modify the code according the business logic
...
def lambda_handler(event, context):
    ...
    source_folder = f"data/Source/{file_name}"
    stage_folder = f"data/Stage/{file_name}"
    error_folder = f"data/Error/{file_name}"
